<x-layouts.admin title="Tambah {{ $type == 'berita' ? 'Berita' : 'Artikel' }}"
    subtitle="Menambahkan {{ strtolower($type == 'berita' ? 'berita' : 'artikel') }} baru ke sistem">
    ...
    <x-main.layouts.breadcrumb :items="[
        ...
        ['title' => 'Tambah ' . ($type == 'berita' ? 'Berita' : 'Artikel')],
    ]" />
                            ...
                            <div>
                                ...
                                <select name="status" id="status"
                                    ...
                                    <option value="publish"
                                        {{ old('status', 'publish') == 'publish' ? 'selected' : '' }}>
                                        Publikasikan</option>
