<x-layouts.admin title="Edit Kecamatan" subtitle="Mengubah data kecamatan yang sudah ada di sistem">

    {{-- Breadcrumb --}}
    <x-main.layouts.breadcrumb :items="[['title' => 'Kecamatan Management', 'url' => route('kecamatan.index')], ['title' => 'Edit Kecamatan']]" />
    ...
    <x-main.cards.content-card>
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Edit Kecamatan</h3>
                    <p class="text-sm text-gray-600">Isi form di bawah untuk mengubah data kecamatan</p>
                </div>
        ...
        <div class="p-6">
            ...
            <form action="{{ route('kecamatan.update', $kecamatans->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                    ...
                    <select name="kabupaten_id" id="kabupaten_id" required
                        ...
                        @foreach ($kabupatens as $kabupaten)
                            <option value="{{ $kabupaten->id }}"
                                {{ (old('kabupaten_id') ?? $kecamatans->kabupaten_id) == $kabupaten->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="text" name="nama_kecamatan" id="nama_kecamatan" required
                        value="{{ old('nama_kecamatan') ?? $kecamatans->nama_kecamatan }}"
