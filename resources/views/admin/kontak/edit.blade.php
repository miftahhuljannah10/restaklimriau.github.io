<x-layouts.admin title="Edit Kontak" subtitle="Mengubah informasi kontak">

    {{-- Breadcrumb --}}
    <x-main.layouts.breadcrumb :items="[['title' => 'Kontak Management', 'url' => route('admin.kontak.index')], ['title' => 'Edit Kontak']]" />
    ...
    <x-main.cards.content-card>
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Edit Kontak: {{ $kontak->key }}</h3>
                    <p class="text-sm text-gray-600">Perbarui informasi kontak di bawah ini</p>
                </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="key" name="key" value="{{ old('key', $kontak->key) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="link" name="link" value="{{ old('link', $kontak->link) }}"
