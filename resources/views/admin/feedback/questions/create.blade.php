<x-layouts.admin title="Tambah Pertanyaan Feedback" subtitle="Menambahkan pertanyaan feedback baru ke sistem">
    ...
    <x-main.cards.content-card>
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Tambah Pertanyaan Feedback</h3>
                    <p class="text-sm text-gray-600">Isi form di bawah untuk menambahkan pertanyaan feedback baru</p>
                </div>
        ...
        <div class="p-6">
            <form action="{{ route('admin.feedback.questions.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <textarea name="question_text" id="question_text" required rows="3"
                                    ...
                                    placeholder="Masukkan pertanyaan feedback">{{ old('question_text') }}</textarea>
                            </div>
                            @error('question_text')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select name="answer_type" id="answer_type"
                                    ...
                                    <option value="text" {{ old('answer_type') == 'text' ? 'selected' : '' }}>Text
                                        (Jawaban Bebas)</option>
                                    <option value="dropdown" {{ old('answer_type') == 'dropdown' ? 'selected' : '' }}>
                        ...
                        <div id="options_section" class="hidden">
