...
@section('content')
    <div class="p-6">
        <div class="max-w-xl mx-auto bg-white shadow-md rounded-lg p-6">
            <h2 class="text-xl font-semibold mb-6 text-gray-800">Tambah Pertanyaan Feedback</h2>
            ...
            <form method="POST" action="{{ route('admin.feedback.questions.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="question_text" id="question_text" required rows="3"
                        class="mt-1 w-full border border-gray-300 rounded px-3 py-2 focus:ring focus:ring-blue-200 focus:outline-none">{{ old('question_text') }}</textarea>
                    @error('question_text')
                ...
                <div id="options_section" class="mb-4 hidden">
