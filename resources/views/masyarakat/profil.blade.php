...
@section('content')
    @php
    // Dummy data untuk seluruh komponen profil
    $heroProfil = [
    ...
    $tentang = [
        ...
        'video_url' => 'https://www.youtube.com/embed/PKJpW0Od0Ks?rel=0',
    ...
    $sejarah = [
        ...
        'timeline' => [
            [ 'tahun' => '2012', 'teks' => 'Penjajakan dan pembuatan unit organisasi Klimatologi di Provinsi Riau', 'icon' => 'fa-lightbulb', 'bg' => 'bg-blue-500', 'border' => 'border-blue-500' ],
            [ 'tahun' => '2013', 'teks' => 'Pembuatan fisik Stasiun Meteorologi Pertanian Khusus Plus (SMPK Plus) Sungai Pinang beralamat di Desa Kuapan, Kec. Tambang, Kab. Kampar', 'icon' => 'fa-building', 'bg' => 'bg-gray-500', 'border' => 'border-gray-500' ],
    ...
    $visiMisi = [
        ...
        'visi' => [
            'deskripsi' => 'Mewujudkan BMKG yang handal, tanggap, dan mampu dalam mendukung keselamatan masyarakat serta keberhasilan pembangunan nasional, dan berperan aktif di tingkat internasional.',
            'detail' => [
        ...
        'tugas' => [
            'deskripsi' => 'Berdasarkan tugas yang tertulis di Instansi Badan Meteorologi, Klimatologi, dan Geofisika (BMKG), Stasiun Klimatologi Riau bertugas melakukan pengamatan cuaca dan iklim, serta menjadi koordinator pengumpulan data curah hujan di Provinsi Riau, serta mempublikasikan informasi cuaca, iklim, dan kualitas udara di seluruh Provinsi Riau.',
            'detail' => [
                [ 'icon' => 'fa-cloud-sun', 'icon_bg' => 'bg-green-500', 'teks' => 'Melaksanakan pengamatan, pengumpulan, penyebaran data, pengolahan, analisa, dan prakiraan di wilayah Provinsi Riau, serta pelayanan jasa klimatologi dan kualitas udara, dan juga pengamatan meteorologi pertanian dan hidrometeorologi.' ],
                [ 'icon' => 'fa-network-wired', 'icon_bg' => 'bg-blue-500', 'teks' => 'Sebagai koordinator pos kerjasama yang meliputi Pos Hujan Kerjasama (PHK), pos hujan otomatis (Automatic Rain Gauge), stasiun pemantau cuaca otomatis (Automatic Weather Station), stasiun meteorologi pertanian otomatis (Agroclimate Automatic Weather Station), dan Stasiun Meteorologi Pertanian Khusus (SMPK) di wilayah Provinsi Riau.' ],
                [ 'icon' => 'fa-clipboard-list', 'icon_bg' => 'bg-orange-500', 'teks' => 'Membuat catatan tentang kejadian penting dari gejala dan atau unsur cuaca/iklim serta dampak dan kerugiannya.' ],
                [ 'icon' => 'fa-cogs', 'icon_bg' => 'bg-purple-500', 'teks' => 'Melaksanakan tugas administrasi yang meliputi ketatausahaan, kepegawaian, keuangan, rumah tangga, dan laporan operasional stasiun.' ]
            ]
        ]
    ];
    $hrSection = [
        'kepala_title' => 'Kepala Stasiun',
        'kepala' => [ 'foto' => '/assets/images/SDM.png', 'nama' => 'Edi Rahmanto, S.Tr', 'jabatan' => 'Kepala Stasiun Klimatologi', 'url' => '/profil-detail?id=kepala-stasiun&type=kepala' ],
        'fungsional_title' => 'Kelompok Jabatan Fungsional',
        'fungsional' => [
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'Nama Staff 1', 'jabatan' => 'Analis Iklim', 'url' => '/profil-detail?id=fungsional-1&type=fungsional' ],
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'Nama Staff 2', 'jabatan' => 'Analis Iklim', 'url' => '/profil-detail?id=fungsional-2&type=fungsional' ],
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'Nama Staff 3', 'jabatan' => 'Analis Iklim', 'url' => '/profil-detail?id=fungsional-3&type=fungsional' ],
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'Nama Staff 4', 'jabatan' => 'Analis Iklim', 'url' => '/profil-detail?id=fungsional-4&type=fungsional' ],
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'Nama Staff 5', 'jabatan' => 'Analis Iklim', 'url' => '/profil-detail?id=fungsional-5&type=fungsional' ],
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'Nama Staff 6', 'jabatan' => 'Analis Iklim', 'url' => '/profil-detail?id=fungsional-6&type=fungsional' ]
        ],
        'ppnpn_title' => 'PPNPN',
        'ppnpn' => [
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'PPNPN 1', 'jabatan' => 'PPNPN', 'url' => '/profil-detail?id=ppnpn-1&type=ppnpn' ],
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'PPNPN 2', 'jabatan' => 'PPNPN', 'url' => '/profil-detail?id=ppnpn-2&type=ppnpn' ],
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'PPNPN 3', 'jabatan' => 'PPNPN', 'url' => '/profil-detail?id=ppnpn-3&type=ppnpn' ],
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'PPNPN 4', 'jabatan' => 'PPNPN', 'url' => '/profil-detail?id=ppnpn-4&type=ppnpn' ],
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'PPNPN 5', 'jabatan' => 'PPNPN', 'url' => '/profil-detail?id=ppnpn-5&type=ppnpn' ]
        ],
        'alumni_title' => 'Alumni Pegawai',
        'alumni' => [
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'Alumni 1', 'jabatan' => 'Alumni Pegawai', 'url' => '/profil-detail?id=alumni-1&type=alumni' ],
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'Alumni 2', 'jabatan' => 'Alumni Pegawai', 'url' => '/profil-detail?id=alumni-2&type=alumni' ],
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'Alumni 3', 'jabatan' => 'Alumni Pegawai', 'url' => '/profil-detail?id=alumni-3&type=alumni' ],
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'Alumni 4', 'jabatan' => 'Alumni Pegawai', 'url' => '/profil-detail?id=alumni-4&type=alumni' ],
            [ 'foto' => '/assets/images/SDM.png', 'nama' => 'Alumni 5', 'jabatan' => 'Alumni Pegawai', 'url' => '/profil-detail?id=alumni-5&type=alumni' ]
        ]
    ];
    $serviceOffices = [
        'tabs' => [
        ...
        'offices' => [
            [
                'id' => 'admin-tab',
                'image' => '/assets/images/administrasi.jpg',
                'image_alt' => 'Kantor Pelayanan Administrasi',
                'title' => 'Kantor Pelayanan Administrasi',
                'description' => 'Kantor Pelayanan Administrasi memberikan layanan berupa informasi bidang Klimatologi dengan berbagai jenis analisis dan prakiraan cuaca yang komprehensif.',
                'services' => [
                    [
                        'title' => 'Analisis',
                        'icon' => '📊',
                    ...
                    [
                        ...
                        'bg_overlay' => 'bg-gradient-to-br from绿色-400/10 to-green-600/10',
                        'icon_color' => '',
                        'hover' => 'green',
                        'items' => [
                            'PM10',
            ...
            [
                'id' => 'operational-tab',
                'image' => '/assets/images/operasional.jpg',
                'image_alt' => 'Kantor Pelayanan Operasional',
                'title' => 'Kantor Pelayanan Operasional',
                'description' => 'Kantor Pelayanan Operasional memberikan layanan teknis dan operasional terkait pengamatan, pengolahan, dan penyebaran data klimatologi.',
                'services' => [
                    [
                        'title' => 'Suhu',
                        'icon' => '🌡️',
                    ...
                    [
                        ...
                        'hover' => 'indigo',
                        'items' => [
                            'Standar BMKG (dalam satuan millimeter)'
                        ]
                    ],
                    [
