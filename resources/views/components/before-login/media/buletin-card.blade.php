<a href="{{ url('buletin-detail/') }}" class="group bg-white rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col cursor-pointer hover:scale-105 h-full block">
