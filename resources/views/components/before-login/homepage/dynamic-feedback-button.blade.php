                    ...
                    @foreach($questions as $question)
                        <div>
                            <label class="block font-semibold mb-1 text-sky-700">
                                ...
                                @if($loop->index < 2)<span class="text-red-500">*</span>@endif
                            </label>
                                ...
                                <div class="flex items-start gap-2">
                                    @if($loop->last)
                                        <textarea name="answers[{{ $question->id }}]" 
                                                ...
                                                @if($loop->index < 2) required @endif></textarea>
                                    ...
                                    @else
                                        <input type="text" 
                                               ...
                                               placeholder="Tuliskan jawaban Anda disini..."
                                               @if($loop->index < 2) required @endif>
                                        <i class="fas fa-{{ $loop->first ? 'bullseye' : 'search' }} text-{{ $loop->first ? 'sky' : 'cyan' }}-400 text-lg"></i>
                                    @endif
                                </div>
                            @endif
                        </div>
