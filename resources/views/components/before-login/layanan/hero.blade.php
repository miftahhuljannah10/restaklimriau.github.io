<section
    class="w-full h-[400px] sm:h-[450px] md:h-[488px] relative overflow-hidden bg-gradient-to-br from-sky-600 to-cyan-300">
    ...
    <div class="flex flex-col items-center md:hidden h-full">
        ...
        <div class="flex flex-col items-center justify-center px-4 text-center mt-0 z-10">
            ...
            <div class="flex flex-col gap-3 w-full">
                ...
                <button
                    class="w-full h-12 rounded-[12px] border-2 border-white bg-transparent hover:bg-white hover:text-sky-600 transition-all duration-300 group shadow-lg hover:shadow-xl backdrop-blur-sm">
                    <span
                        class="text-white group-hover:text-sky-600 text-xs sm:text-sm font-medium font-montserrat group-hover:scale-105 transition-all duration-300 px-2">
    ...
    <div class="hidden md:block h-full">
        ...
        <div class="relative z-10 flex flex-col justify-center h-full px-8 lg:px-[60px] xl:px-[89px]">
            ...
            <div class="w-full max-w-[400px] lg:max-w-[500px] mb-6">
                <h1
                    class="text-white text-3xl lg:text-4xl xl:text-4xl font-bold font-montserrat leading-tight drop-shadow-lg">
                    Permintaan Data
                </h1>
            </div>
            ...
            <div class="w-full max-w-[500px] lg:max-w-[600px] xl:max-w-[716px] mb-10 lg:mb-12">
                <p
                    class="text-white text-lg lg:text-xl xl:text-2xl font-normal font-montserrat leading-relaxed drop-shadow-md">
                    Alur Pelayanan Mengenai Mekanisme Pelayanan PNBP Stasiun Klimatologi Riau dan Jenis Form Pengajuan.
                </p>
            </div>
            ...
            <div class="flex flex-row gap-4 max-w-[600px]">
                <!-- Cek Ketersediaan Data Button -->
                <button
                    class="min-w-[220px] lg:min-w-[240px] xl:w-64 h-16 lg:h-18 rounded-[16px] border-2 border-white bg-transparent hover:bg-white hover:text-sky-600 transition-all duration-300 group shadow-lg hover:shadow-xl backdrop-blur-sm">
                    <span
                        class="text-white group-hover:text-sky-600 text-base lg:text-lg font-medium font-montserrat group-hover:scale-105 transition-all duration-300 px-2">
                        Cek Ketersediaan Data
                    </span>
                </button>
