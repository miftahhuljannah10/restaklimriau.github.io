...
<x-after-login.sidebar.item-icon icon="users" name="Manajemen Hak Akses" route="users.index" />
<x-after-login.sidebar.item-icon icon="user" name="Akun Kepegawaian" route="pegawai.index" />
